    ...
    return (
        <div>
            <div className='relative flex items-center justify-center lg:h-[100vh] bg-black md:h-[60vh] h-[40vh] overflow-hidden'>
                ...
                <img src={c2} alt="" className='left-20 top-72 absolute w-72  hidden lg:block' />
                ...
                <div className='absolute flex gap-5 flex-col items-center justify-center font-[head] text-[#323437]  '>
                    ...
                    <motion.p
                        ...
                        className='text-xl lg:text-2xl text-center text-[#535355] '>Transport your taste buds to the heart of Chinese cuisine with these scrumptious dishes.</motion.p>
                </div>
            </div>
        </div>
    )
