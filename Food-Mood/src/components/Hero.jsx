...
const Hero = () => {
    return (
        <div className="h-[140vh] relative">
            ...
            <div className='absolute h-full w-full flex justify-center lg:gap-32 items-start mt-32'>
                ...
                <div className='text-white mt-52'>
                    <motion.h1 initial={{ translateX: 800 }} animate={{ translateX: 0 }} transition={{ duration: 0.7, ease: 'easeIn', delay: 0.2 }} className='lg:text-7xl md:text-6xl text-5xl font-[nova]  font-bold '>Delivering </motion.h1>
                    <motion.h1 initial={{ translateX: 800 }} animate={{ translateX: 0 }} transition={{ duration: 0.7, ease: 'easeIn', delay: 0.4 }} className='lg:text-7xl md:text-6xl  text-5xl font-[boldest]  font-bold '>happiness</motion.h1>
                    <motion.h1 initial={{ translateX: 800 }} animate={{ translateX: 0 }} transition={{ duration: 0.7, ease: 'easeIn', delay: 0.4 }} className='lg:text-4xl md:text-6xl  text-5xl font-[boldest]  font-bold flex items-center gap-2'>to Doors<BsFillDoorOpenFill /> </motion.h1>
                </div>
            </div>
