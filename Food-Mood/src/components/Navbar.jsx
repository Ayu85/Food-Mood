...
const Navbar = () => {
    ...
    return (
        <div className={`flex ${isScrolled && "bg-[#ffffff9f] backdrop-blur-md"}  transition-all duration-100 justify-between py-2 fixed top-0 z-[9999] w-full items-center bg-[#ffffff00] px-10 font-[gorg-medium] font-medium  text-lg`}>
